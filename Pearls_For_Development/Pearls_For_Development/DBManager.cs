...
{
    // we control our database here ... connections, excution of queries,etc. ---> mainly we won't change anything here just the name of our server.
    public class DBManager
    {
        static string DB_Connection_String = @"Data Source=YAHIA;Initial Catalog=Al_Ahly_Club;Integrated Security=True";
